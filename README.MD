...
<!-- PIN CARD SUBL1St3r -->
<a href="https://gist.github.com/michele-tn/1334d8796d2c4e308f9da69d34db49b6" target="_blank" style="text-decoration: none;">
  <div style="
    width: 420px;
    background: #0d1117;
  ...
  onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='none';">
    ...
    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="#8b949e">
        <path d="M3 3h18v18H3z" fill="none" stroke="#8b949e" stroke-width="2"/>
      </svg>
      <span style="font-size: 18px; font-weight: 600; color: #58a6ff;">
        Sublist3r — ADVANCED LINUX DIAGNOSTIC SCRIPTS
      </span>
    </div>
    <!-- Description -->
    <div style="font-size: 14px; color: #8b949e; margin-bottom: 14px;">
      Utility avanzate per diagnosticare, enumerare e analizzare host e sottodomini tramite Sublist3r.
    </div>
